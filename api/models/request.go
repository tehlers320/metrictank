...
func NewReq(key, target string, from, to, maxPoints, rawInterval uint32, consolidator consolidation.Consolidator, node cluster.NodeIf, schemaId, aggId uint16) Req {
	return Req{
		key,
		target,
		from,
